...
![data0目录结构](https://img.learnblockchain.cn/2018/create_private_blockchain_1.png!wl)
...
初始化成功后的目录如下：
![初始化成功](https://img.learnblockchain.cn/2018/create_private_blockchain_2.png!wl)
...
![进入了Javascript Console](https://img.learnblockchain.cn/2018/create_private_blockchain_3.png!wl)
...
![两个账户](https://img.learnblockchain.cn/2018/create_private_blockchain_4.png!wl)
json文件中信息格式如下：
