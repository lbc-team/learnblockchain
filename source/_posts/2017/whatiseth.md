...
有兴趣可以阅读[完全了解智能合约运行原理](https://learnblockchain.cn/2018/01/04/understanding-smart-contracts/)进一步了解智能合约。
...
[Remix](https://remix.ethereum.org/)是一个基于浏览器的Solidity IDE, 大家可以点进去看看，非常容易上手， 了解更多Solidity知识，可以参考社区翻译的[Solidity中文文档](https://learnblockchain.cn/docs/solidity/)。
